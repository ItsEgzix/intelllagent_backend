...
function getWelcomeEmailTemplate() {
    ...
    const possiblePaths = [
        path.join(projectRoot, 'src', 'images', 'intellagent_logo_png.png'),
        path.join(projectRoot, 'dist', 'images', 'intellagent_logo_png.png'),
        path.join(projectRoot, 'images', 'intellagent_logo_png.png'),
    ];
    ...
    try {
        ...
        if (error instanceof Error) {
            console.error(...oo_tx(`2593955902_82_6_82_52_11`, 'Error message:', error.message));
        }
    }
    const html = `
<!DOCTYPE html>
