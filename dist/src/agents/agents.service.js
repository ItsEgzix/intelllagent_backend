...
let AgentsService = class AgentsService {
    ...
    async findActive() {
        try {
            ...
            console.error(...oo_tx(`655168149_152_6_152_50_11`, 'Error in findActive:', error));
            try {
                await this.prisma.$disconnect();
                await this.prisma.$connect();
            }
            catch (reconnectError) {
                console.error(...oo_tx(`655168149_158_8_158_61_11`, 'Failed to reconnect:', reconnectError));
            }
            throw error;
        }
    }
    ...
    async getAvailableTimeSlots(agentId, date, customerTimezone) {
        ...
        for (const agentSlot of availableAgentSlots) {
            try {
                ...
                console.error(...oo_tx(`655168149_357_8_357_55_11`, 'Error converting time slot:', e));
            }
        }
