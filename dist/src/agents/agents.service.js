...
let AgentsService = class AgentsService {
    ...
    async onModuleInit() {
        try {
            ...
            console.log(...oo_oo(`1429794113_21_6_21_59_4`, 'AgentsService: Prisma client connected'));
        }
        catch (error) {
            console.error(...oo_tx(`1429794113_23_6_23_75_11`, 'AgentsService: Failed to connect to database:', error));
        }
    }
    async onModuleDestroy() {
        try {
            await this.prisma.$disconnect();
            console.log(...oo_oo(`1429794113_30_6_30_62_4`, 'AgentsService: Prisma client disconnected'));
        }
        catch (error) {
            console.error(...oo_tx(`1429794113_32_6_32_65_11`, 'AgentsService: Error disconnecting:', error));
        }
    }
    ...
    async findActive() {
        try {
            ...
            console.error(...oo_tx(`1429794113_175_6_175_50_11`, 'Error in findActive:', error));
            try {
                await this.prisma.$disconnect();
                await this.prisma.$connect();
            }
            catch (reconnectError) {
                console.error(...oo_tx(`1429794113_181_8_181_61_11`, 'Failed to reconnect:', reconnectError));
            }
            throw error;
        }
    }
    ...
    async getAvailableTimeSlots(agentId, date, customerTimezone) {
        ...
        for (const agentSlot of availableAgentSlots) {
            try {
                ...
                console.error(...oo_tx(`1429794113_362_8_362_55_11`, 'Error converting time slot:', e));
            }
        }
