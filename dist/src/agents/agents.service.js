...
let AgentsService = class AgentsService {
    prisma = new client_1.PrismaClient({ adapter: prisma_config_1.adapter });
    async onModuleInit() {
        try {
            await this.prisma.$connect();
            console.log(...oo_oo(`2716006049_22_6_22_59_4`, 'AgentsService: Prisma client connected'));
        }
        catch (error) {
            console.error(...oo_tx(`2716006049_24_6_24_75_11`, 'AgentsService: Failed to connect to database:', error));
        }
    }
    async onModuleDestroy() {
        try {
            await this.prisma.$disconnect();
            console.log(...oo_oo(`2716006049_31_6_31_62_4`, 'AgentsService: Prisma client disconnected'));
        }
        catch (error) {
            console.error(...oo_tx(`2716006049_33_6_33_65_11`, 'AgentsService: Error disconnecting:', error));
        }
    }
    ...
    async findActive() {
        try {
            ...
            console.error(...oo_tx(`2716006049_176_6_176_50_11`, 'Error in findActive:', error));
            try {
                await this.prisma.$disconnect();
                await this.prisma.$connect();
            }
            catch (reconnectError) {
                console.error(...oo_tx(`2716006049_182_8_182_61_11`, 'Failed to reconnect:', reconnectError));
            }
            throw error;
        }
    }
    ...
    async getAvailableTimeSlots(agentId, date, customerTimezone) {
        ...
        for (const agentSlot of availableAgentSlots) {
            try {
                ...
                console.error(...oo_tx(`2716006049_379_8_379_55_11`, 'Error converting time slot:', e));
            }
        }
