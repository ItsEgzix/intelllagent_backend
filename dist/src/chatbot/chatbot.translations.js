...
function getMessagesDirectory() {
    ...
    throw new Error('Messages directory not found. Please ensure the messages folder exists.');
}
...
function writeTranslationFile(languageCode, content) {
    const messagesDir = getMessagesDirectory();
...
${jsonString}`;
    try {
        ...
        console.error(...oo_tx(`1061959206_132_4_132_51_11`, 'Error translating JSON:', error));
...
async function translateWebsite(targetLanguage, apiKey) {
    try {
        ...
        console.error(...oo_tx(`1061959206_182_4_182_54_11`, 'Error translating website:', error));
        return {
            success: false,
...
function updateLanguageRegistry(languageCode, languageName, languageNameEn) {
    try {
        const messagesDir = getMessagesDirectory();
        ...
        console.log(...oo_oo(`1061959206_305_4_307_5_4`, `Language ${languageCode} added to runtime registry successfully.`));
    }
    catch (error) {
        console.error(...oo_tx(`1061959206_309_4_309_61_11`, 'Error updating language registry:', error));
    }
}
