...
exports.getCurrentDateTimeContext = getCurrentDateTimeContext;
...
function buildSystemPrompt(ragContext) {
    const { date: currentDate, time: currentTime, day: currentDay, } = getCurrentDateTimeContext();
...
//# sourceMappingURL=chatbot.prompts.js.map