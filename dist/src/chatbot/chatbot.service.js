...
let ChatbotService = class ChatbotService {
    ...
    constructor(meetingsService, agentsService) {
        ...
        if (!apiKey) {
            ...
            try {
                ...
                console.error(...oo_tx(`2867536759_41_8_41_65_11`, 'Failed to initialize GoogleGenAI:', error));
            }
        }
    }
    async onModuleInit() {
        ...
        try {
            ...
            if (contextPath) {
                try {
                    ...
                    console.log(...oo_oo(`2867536759_80_10_80_64_4`, `RAG context loaded from: ${contextPath}`));
                }
                catch (readError) {
            ...
            console.error(...oo_tx(`2867536759_93_6_93_56_11`, 'Error loading RAG context:', error));
            this.ragContext = '';
        }
    }
    ...
    async processResponseRecursively(session, systemPrompt, tools, maxIterations = 5) {
        ...
        if (!responseText && functionCalls && functionCalls.length > 0) {
            console.log(...oo_oo(`2867536759_190_6_192_7_4`, `Response has ${functionCalls.length} function call(s) but no text. Processing function calls...`));
        }
        if (!responseText && functionCalls && functionCalls.length > 0) {
            console.log(...oo_oo(`2867536759_197_6_199_7_4`, `Response has ${functionCalls.length} function call(s) but no text. Processing function calls...`));
        }
        if (functionCalls && functionCalls.length > 0) {
            ...
            for (const funcCall of functionCalls) {
                ...
                const result = await (0, chatbot_functions_1.handleFunctionCall)(functionName, args, services);
    ...
    async sendMessage(message, sessionId) {
        ...
        try {
            ...
            console.error(...oo_tx(`2867536759_476_6_476_55_11`, 'Error calling Gemini API:', error));
