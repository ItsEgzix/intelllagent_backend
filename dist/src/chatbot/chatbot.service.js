...
let ChatbotService = class ChatbotService {
    ...
    constructor(meetingsService, agentsService, translationsService) {
        ...
        if (!chatbot_config_1.GEMINI_CONFIG.API_KEY) {
            ...
            try {
                ...
                console.error(...oo_tx(`3385516273_58_8_58_65_11`, 'Failed to initialize GoogleGenAI:', error));
            }
        }
    }
    async onModuleInit() {
        ...
        try {
            ...
            if (contextPath) {
                try {
                    ...
                    console.log(...oo_oo(`3385516273_97_10_97_64_4`, `RAG context loaded from: ${contextPath}`));
                }
                catch (readError) {
            ...
            console.error(...oo_tx(`3385516273_110_6_110_56_11`, 'Error loading RAG context:', error));
            this.ragContext = '';
        }
    }
    ...
    async processResponseRecursively(session, systemPrompt, tools, maxIterations = chatbot_config_1.GEMINI_CONFIG.SESSION.MAX_ITERATIONS) {
        ...
        if (!responseText && functionCalls && functionCalls.length > 0) {
            console.log(...oo_oo(`3385516273_218_6_220_7_4`, `Response has ${functionCalls.length} function call(s) but no text. Processing function calls...`));
        }
        if (!responseText && functionCalls && functionCalls.length > 0) {
            console.log(...oo_oo(`3385516273_225_6_227_7_4`, `Response has ${functionCalls.length} function call(s) but no text. Processing function calls...`));
        }
    ...
    async sendMessage(message, sessionId) {
        ...
        try {
            ...
            if (error instanceof Error) {
                ...
                console.error(...oo_tx(`3385516273_648_8_653_10_11`, 'Error calling Gemini API:', {
                ...
                console.error(...oo_tx(`3385516273_655_8_655_65_11`, 'Unknown error calling Gemini API:', error));
            }
