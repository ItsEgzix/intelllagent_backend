...
let ChatbotService = class ChatbotService {
    ...
    constructor(meetingsService, agentsService, translationsService) {
        ...
        if (!apiKey) {
            ...
            try {
                ...
                console.error(...oo_tx(`2751939575_43_8_43_65_11`, 'Failed to initialize GoogleGenAI:', error));
            }
        }
    }
    async onModuleInit() {
        ...
        try {
            ...
            if (contextPath) {
                try {
                    ...
                    console.log(...oo_oo(`2751939575_82_10_82_64_4`, `RAG context loaded from: ${contextPath}`));
                }
                catch (readError) {
            ...
            console.error(...oo_tx(`2751939575_95_6_95_56_11`, 'Error loading RAG context:', error));
            this.ragContext = '';
        }
    }
    ...
    async processResponseRecursively(session, systemPrompt, tools, maxIterations = 5) {
        ...
        if (!responseText && functionCalls && functionCalls.length > 0) {
            console.log(...oo_oo(`2751939575_191_6_193_7_4`, `Response has ${functionCalls.length} function call(s) but no text. Processing function calls...`));
        }
        if (!responseText && functionCalls && functionCalls.length > 0) {
            console.log(...oo_oo(`2751939575_198_6_200_7_4`, `Response has ${functionCalls.length} function call(s) but no text. Processing function calls...`));
        }
    ...
    async sendMessage(message, sessionId) {
        ...
        try {
            ...
            console.error(...oo_tx(`2751939575_487_6_487_55_11`, 'Error calling Gemini API:', error));
