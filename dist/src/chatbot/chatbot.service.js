...
let ChatbotService = class ChatbotService {
    ...
    constructor(meetingsService, agentsService, translationsService) {
        ...
        if (!apiKey) {
            ...
            try {
                ...
                console.error(...oo_tx(`2555036485_43_8_43_65_11`, 'Failed to initialize GoogleGenAI:', error));
            }
        }
    }
    async onModuleInit() {
        ...
        try {
            ...
            if (contextPath) {
                try {
                    ...
                    console.log(...oo_oo(`2555036485_82_10_82_64_4`, `RAG context loaded from: ${contextPath}`));
                }
                catch (readError) {
            ...
            console.error(...oo_tx(`2555036485_95_6_95_56_11`, 'Error loading RAG context:', error));
            this.ragContext = '';
        }
    }
    ...
    async processResponseRecursively(session, systemPrompt, tools, maxIterations = 5) {
        if (maxIterations <= 0) {
            console.warn('Max iterations reached in processResponseRecursively');
            return null;
        }
        const response = await this.retryWithBackoff(() => this.genAI.models.generateContent({
        ...
        if (!responseText && functionCalls && functionCalls.length > 0) {
            console.log(...oo_oo(`2555036485_194_6_196_7_4`, `Response has ${functionCalls.length} function call(s) but no text. Processing function calls...`));
        }
        if (!responseText && functionCalls && functionCalls.length > 0) {
            console.log(...oo_oo(`2555036485_201_6_203_7_4`, `Response has ${functionCalls.length} function call(s) but no text. Processing function calls...`));
        }
    ...
    async sendMessage(message, sessionId) {
        ...
        try {
            ...
            if (functionCalls && functionCalls.length > 0) {
                ...
                let finalResponseText = await this.processResponseRecursively(session, systemPrompt, tools);
            ...
            if (error instanceof Error) {
                ...
                console.error(...oo_tx(`2555036485_577_8_582_10_11`, 'Error calling Gemini API:', {
                ...
                console.error(...oo_tx(`2555036485_584_8_584_65_11`, 'Unknown error calling Gemini API:', error));
            }
