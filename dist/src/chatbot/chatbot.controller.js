...
let ChatbotController = class ChatbotController {
    ...
    async sendMessage(sendMessageDto) {
        try {
            ...
            throw new common_1.HttpException(error instanceof Error ? error.message : 'Failed to process message', common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    async getSessionHistory(sessionId) {
        try {
            ...
            throw new common_1.HttpException('Failed to get session history', common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    async clearSession(sessionId) {
        try {
            ...
            throw new common_1.HttpException('Failed to clear session', common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    async getAllSessions() {
        try {
            ...
            throw new common_1.HttpException('Failed to get sessions', common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
};
